 ...
 if(isset($_POST['btnok']))
  {
			...
			if(isset($_FILES['imgf2']['name']))
			{
				if($_FILES['imgf2']['name']=='')
				{
					$newimage2=$oldimg2;
				}
				else
			...
			if(isset($_FILES['imgf3']['name']))
			{
				if($_FILES['imgf3']['name']=='')
				{
					$newimage3=$oldimg3;
				}
				else
				{
					...
					move_uploaded_file($_FILES['imgf3']['tmp_name'],"upload_image/".$newimage3);
				}
			}
			else
			{
			...
			if(isset($_FILES['imgf4']['name']))
			{
				if($_FILES['imgf4']['name']=='')
				{
					$newimage4=$oldimg4;
				}
				else
			...
			$qu = "update r_image set image_1='$newimage1',image_2='$newimage2',image_3='$newimage3',image_4='$newimage4' where recipe_image_id='$reid'";
			$q=mysqli_query($con,$qu);
			if($q)
			{
				?>
				<script>
						window.location="managerecipe.php";
				</script>
				<?php
			}
			else

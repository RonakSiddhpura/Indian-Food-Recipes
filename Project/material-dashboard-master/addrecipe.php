...
if(isset($_POST['btnok']))
{
 ...
 $sql = "INSERT INTO r_details( `recipe_name`, ingredients,  `video_link`, r_description1,r_description2,r_description3, category_id) VALUES ('$Rname','$ingre','$VLink','$Descri1','$Descri2','$Descri3','$cate')";
  ...
  <main class="main-content  mt-0">
            ...
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-primary shadow-primary border-radius-lg py-2 pe-1">
                  <h4 class="text-white font-weight-bolder text-center mt-2 mb-0">Add Recipes</h4>
	...
	?>
                  ...
                  <label>Recipes Name:-</label>
                    <input type="text" name="RecipesName" placeholder="Recipes Name"></br></br>
					
					<label>Video Link:-</label>
                    <input type="text" name="VLink" placeholder="Video Link"></br></br>
					
					<label>Recipe Ingredients:-</label>
           <textarea rows = "" cols = "50" name="ingredients" > Ingredients</textarea></br></br>
					
					<label>Recipe Description 1:-</label>
				<textarea rows = "2" cols = "50" name="Description1" > Description </textarea>  </br></br>
					
					<label>Recipe Description 2:-</label><textarea rows = "2" cols = "50"  name="Description2" > Description
         </textarea>  </br></br>
					
					<label>Recipe Description 3:-</label>
                   <textarea rows = "2" cols = "50"   name="Description3" >Description </textarea>  </br></br>

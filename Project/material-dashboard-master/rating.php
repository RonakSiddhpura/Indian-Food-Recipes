...
<!-- End Navbar -->
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h1 class="text-white text-capitalize ps-3">View Rating </h1>
              </div>
            </div>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Recipe id</th>
 ...
 <?php
	...
	$i=$_REQUEST['raid'];
	$qu = "Select * from r_rating where recipe_id='$i'";
 ...
 <?php echo $row['recipe_id']?>					  
					  ...
					  <td class="align-middle text-center">
                               <p class="text-xs font-weight-bold mb-0"> <?php echo $row['r_date']?></p>
                      </td>  
					  
					  <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold"> <?php echo $row['stars']?></SPAN>
                      </td>
					 
					
					 
					 <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold"><a href="ratingdelete.php?id=<?php echo $row['user_id'];?>& rid=<?php echo $row['recipe_id'];?>" >Delete</a></SPAN>
                      </td>
                    </tr>
